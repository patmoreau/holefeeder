export const en = {
  ...
  onboarding: {
    ...
    firstAccountFinish: 'Finish',
    categoriesTitle: 'What do you spend on?',
    categoriesSubtitle: 'Pick a few to start with. You can rename, add or remove them later.',
    categoriesFinish: 'Finish',
    categoriesSkip: 'Skip for now',
    suggestedCategories: {
      groceries: 'Groceries',
