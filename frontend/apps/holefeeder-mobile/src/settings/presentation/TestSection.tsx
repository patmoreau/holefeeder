  ...
  return (
    <>
      <AppFieldSection title={t(tk.testSection.title)}>
        <AppFieldLink
          label={t(tk.testSection.notFoundPage)}
          icon={AppIconMap.warning}
          onPress={() => {
        ...
        />
        <AppFieldLink label={t(tk.testSection.testComponents)} icon={AppIconMap.warning} onPress={() => setShow(!show)} />
      </AppFieldSection>
    </>
  );
};
