...
final serverUrl = dotenv.env['API_SERVER_URL'] ?? '';
...
const auth0Scopes = {'openid', 'profile', 'email', 'offline_access', 'read:user', 'write:user'};

const auth0Logo = 'https://cdn.auth0.com/blog/hub/code-samples/hello-world/auth0-logo.svg';
