...
namespace DrifterApps.Holefeeder.Services.API.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> GetTransactionsAsync(string id, [FromQuery] int? offset, [FromQuery] int? limit, [FromQuery] string[] sort, CancellationToken cancellationToken = default)
        {
            ...
            return Ok(_mapper.Map<TransactionDTO[]>(_transactionService.FindAsync(userId, new QueryParams(offset, limit, sort, new string[] {$"account='{id}'"}), cancellationToken).ConfigureAwait(false)));
        }
