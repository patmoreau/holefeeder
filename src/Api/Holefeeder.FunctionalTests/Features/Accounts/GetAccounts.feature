...
Feature: Accounts
    ...
    Scenario: HappyPath
        ...
        When I try to GetAccounts using query params with offset '' and limit '' and sorts '-code' and filters ''
        Then I expect a '200' status code
        And I get my expected accounts
          | Id                                   | Code    | Data    |
    ...
    Scenario: Invalid Request
        Given I am authorized
        When I try to GetAccounts using query params with offset '0' and limit '-1' and sorts 'date' and filters 'code:eq:settings'
