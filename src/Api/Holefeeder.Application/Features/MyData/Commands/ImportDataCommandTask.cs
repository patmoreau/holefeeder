...
public partial class ImportData
{
    public class BackgroundTask : IBackgroundTask<Request, ImportDataStatusDto>
    {
        ...
        //
        // private async Task ImportCategoriesAsync(Guid userId, Azure.Core.Request request,
        ...
        // }
        //
        // private async Task ImportCashflowsAsync(Guid userId, Azure.Core.Request request,
        //     Action<ImportDataStatusDto> updateProgress, CancellationToken cancellationToken)
        // {
        ...
        //
        //
        // private async Task ImportTransactionsAsync(Guid userId, Azure.Core.Request request,
        //     Action<ImportDataStatusDto> updateProgress, CancellationToken cancellationToken)
        // {
