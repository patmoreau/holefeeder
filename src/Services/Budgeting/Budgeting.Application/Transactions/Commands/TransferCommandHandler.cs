...
{
    public class
        TransferCommandHandler : IRequestHandler<TransferCommand,
            CommandResult<Guid>>
    {
        ...
        public async Task<CommandResult<Guid>> Handle(TransferCommand request,
            CancellationToken cancellationToken)
        {
            ...
            return errors.Any()
                ...
                : CommandResult<Guid>.Create(CommandStatus.Created, transactionFrom.Id);
        }
    }
}
