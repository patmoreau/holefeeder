...
public class PayCashflowCommandHandler : IRequestHandler<PayCashflowCommand, Guid>
{
    ...
    public async Task<Guid> Handle(PayCashflowCommand request, CancellationToken cancellationToken)
    {
        var cashflow =
