...
public class MakePurchaseCommandHandler : IRequestHandler<MakePurchaseCommand, Guid>
{
    ...
    public async Task<Guid> Handle(MakePurchaseCommand request, CancellationToken cancellationToken)
    {
