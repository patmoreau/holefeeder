...
{
    public class AccountsQueriesRepository : IAccountQueriesRepository
    {
        private readonly IMongoDbContext _dbContext;

        public AccountsQueriesRepository(IMongoDbContext context)
        {
        ...
        {
            var accountCollection = await _dbContext.GetAccountsAsync(cancellationToken);
            var transactionCollection = await _dbContext.GetTransactionsAsync(cancellationToken);
            var categoryCollection = await _dbContext.GetCategoriesAsync(cancellationToken);
        ...
        private async Task<string> GetUserMongoId(Guid id, CancellationToken cancellationToken)
        {
