...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    importProvidersFrom(RouterModule.forRoot(ROUTES, {
        ...
        config: {
            authority: 'https://holefeeder.b2clogin.com/holefeeder.onmicrosoft.com/B2C_1A_signup_signin_drifterapps/v2.0',
            authWellknownEndpointUrl: 'https://holefeeder.b2clogin.com/holefeeder.onmicrosoft.com/B2C_1A_signup_signin_drifterapps/v2.0/.well-known/openid-configuration',
            redirectUrl: window.location.origin,
            postLogoutRedirectUri: window.location.origin,
            clientId: '9814ecda-b8db-4775-a361-714af29fe486',
            scope: 'openid profile offline_access https://holefeeder.onmicrosoft.com/holefeeder.api/holefeeder.user',
            responseType: 'code',
            silentRenew: true,
