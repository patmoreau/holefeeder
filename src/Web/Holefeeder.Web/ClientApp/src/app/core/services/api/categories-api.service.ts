...
export class CategoriesApiService {
  constructor(private http: HttpClient, @Inject('BASE_API_URL') private apiUrl: string, private adapter: CategoryAdapter) { }
  ...
  findOneById(id: number | string): Observable<Category> {
    return this.http.get(`${this.apiUrl}/${apiRoute}/${id}`)
