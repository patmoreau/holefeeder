...
{
    public class AccountsQueriesRepositoryTests : IClassFixture<DbFixture>
    {
        private readonly DbFixture _fixture;

        public AccountsQueriesRepositoryTests(DbFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async void GivenGetAccounts_WhenNoFilter_ThenReturnResultsForUser()
        {
            ...
            var repository = new AccountsQueriesRepository(_fixture.DbContext);
