...
{
    public class UpcomingQueriesRepositoryTests : IClassFixture<DbFixture>
    {
        private readonly DbFixture _fixture;

        public UpcomingQueriesRepositoryTests(DbFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        private void InitBaseData(string testName)
        {
            _testUsers ??= new[]
            {
                ...
                _fixture.DbContext.CreateTestUserSchema($"{testName}#3")
            };
            _accounts ??= new[]
            {
                ...
                _fixture.DbContext.CreateAccountSchema(5, AccountType.Checking, _testUsers[2])
            };
            _categories = new[]
            {
                ...
                _fixture.DbContext.CreateCategorySchema(4, CategoryType.Expense, _testUsers[2])
            };
            _cashflows = new[]
            {
                _fixture.DbContext.CreateCashflowSchema(1, _accounts[0], _categories[0], 111,
            ...
            _transactions = new[]
            {
                ...
                _fixture.DbContext.CreateTransactionSchema(7, _accounts[4], _categories[3], 20, _testUsers[2])
            };
        }
