...
public static class CategoryErrors
{
    ...
    public const string CodeNotFound = $"{nameof(Category)}.{nameof(NotFound)}";
    ...
    public static ResultError NotFound(CategoryId id) => new(CodeNotFound, $"Category '{id}' not found");
}
